...
class Flight:
    ...
    def construct_flights(self):
        ...
        offer['flight_number'] = self.flight['itineraries'][0]['segments'][0]['carrierCode'] + " " + self.flight['itineraries'][0]['segments'][0]['number']  # Add flight number
...
def get_airline_logo(carrier_code):
    return "https://www.gstatic.com/flights/airline_logos/70px/" + carrier_code + ".png"
