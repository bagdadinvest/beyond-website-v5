...
const iconNavbarSidenavNew = document.getElementById('iconNavbarSidenavNew'); // New Button
...
if (iconNavbarSidenav) {
  iconNavbarSidenav.addEventListener("click", toggleSidenavOriginal);
}

if (iconNavbarSidenavNew) {
  iconNavbarSidenavNew.addEventListener("click", toggleSidenavNew); // Attach to new button
}

if (iconSidenav) {
  iconSidenav.addEventListener("click", toggleSidenavOriginal);
}

// Function for the original button
function toggleSidenavOriginal() {
  console.log('Toggle Sidenav clicked by Original Button'); // Debug
  console.log('Body classes before (Original):', body.classList);
  if (body.classList.contains(className)) {
    body.classList.remove(className);
    console.log('Removed class (Original):', className);
    setTimeout(function() {
      sidenav.classList.remove('bg-white');
      console.log('Removed class bg-white from sidenav (Original)');
    }, 100);
    sidenav.classList.add('bg-transparent');
    console.log('Added class bg-transparent to sidenav (Original)');
    console.log('Sidebar collapsed (Original)'); // Debug
  } else {
    body.classList.add(className);
    console.log('Added class (Original):', className);
    sidenav.classList.add('bg-white');
    sidenav.classList.remove('bg-transparent');
    iconSidenav.classList.remove('d-none');
    console.log('Added class bg-white and removed bg-transparent from sidenav (Original)');
    console.log('Sidebar expanded (Original)'); // Debug
  }
}

// Function for the new button
function toggleSidenavNew() {
  console.log('Toggle Sidenav clicked by New Button'); // Debug
  console.log('Body classes before (New):', body.classList);
  if (body.classList.contains(className)) {
    body.classList.remove(className);
    console.log('Removed class (New):', className);
    setTimeout(function() {
      sidenav.classList.remove('bg-white');
      console.log('Removed class bg-white from sidenav (New)');
    }, 100);
    sidenav.classList.add('bg-transparent');
    console.log('Added class bg-transparent to sidenav (New)');
    console.log('Sidebar collapsed (New)'); // Debug
  } else {
    body.classList.add(className);
    console.log('Added class (New):', className);
    sidenav.classList.add('bg-white');
    sidenav.classList.remove('bg-transparent');
    iconSidenav.classList.remove('d-none');
    console.log('Added class bg-white and removed bg-transparent from sidenav (New)');
    console.log('Sidebar expanded (New)'); // Debug
  }
}
